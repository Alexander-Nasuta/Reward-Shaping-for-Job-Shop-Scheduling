...
mask_ppo_sweep_config_orb04 = {
    ...
    'parameters': {
        ...
        # env params
        "instance_path": {
            'value': str(get_instance_std_path_by_name("orb04"))
        },
...
if __name__ == '__main__':
    sweep_id = wb.sweep(mask_ppo_sweep_config_orb04, project="reward-functions-comparison")
    wb.agent(
        sweep_id,
